...
from sim.amber import AMBER_param
from sim.sim import Simulate
from sim.utils import dict_from_yaml, cal_rmsf


def sim_eval(yml_file, pdb=None, amber_bin: str = '', device_openmm=0) -> np.ndarray:
